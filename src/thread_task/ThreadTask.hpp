...
=============================================================================*/
#ifndef SRC_THREAD_TASK_THREAD_TASK_HPP
#define SRC_THREAD_TASK_THREAD_TASK_HPP
...
namespace ktl {
	...
	{
		sprig::krkr::tjs::object_type control_obj = sprig::krkr::tjs::CreateNewObject(
...
#endif	// #ifndef SRC_THREAD_TASK_THREAD_TASK_HPP
