...
=============================================================================*/
#ifndef SRC_SPRITES_SPRITES_HPP
#define SRC_SPRITES_SPRITES_HPP
	...
	sprig::krkr::tjs::object_type NativeSprites::multiPointHitTest(tjs_int numparams, tTJSVariant** param) {
		...
		for (std::size_t i = 0; i != numparams; ++i) {
			...
			point.push_back(coord_type(
				static_cast<FLOAT>(sprig::krkr::tjs::GetPropValue<tjs_int>(param_obj, 0)),
				static_cast<FLOAT>(sprig::krkr::tjs::GetPropValue<tjs_int>(param_obj, 1)),
				0.0f
				));
		}
...
#endif	// #ifndef SRC_SPRITES_SPRITES_HPP
