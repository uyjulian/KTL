...
=============================================================================*/
#ifndef SRC_BZIP2_BZIP2_DECOMPRESSOR_DECL_HPP
#define SRC_BZIP2_BZIP2_DECOMPRESSOR_DECL_HPP
...
namespace ktl {
	...
	public:
		...
		typedef boost::iostreams::basic_bzip2_decompressor<std::allocator<byte_type> > filter_type;
	...
	{
	private:
		boost::shared_ptr<NativeBzip2Decompressor> instance_;
	public:
		Bzip2Decompressor();
...
#endif	// #ifndef SRC_BZIP2_BZIP2_DECOMPRESSOR_DECL_HPP
