...
=============================================================================*/
#ifndef SRC_SERIALIZATION_SERIALIZATION_DECL_HPP
#define SRC_SERIALIZATION_SERIALIZATION_DECL_HPP
...
namespace ktl {
	...
	public:
		...
		void save(
			...
			key_type const& key,
			tTJSVariant const* v,
			boost::optional<key_type> ser_key = boost::none
			);
		void load(
			tTJSVariant const* ar_v,
			key_type const& key,
	...
	public:
		...
		void save(
			...
			tTJSString const& key,
			tTJSVariant const* v,
			boost::optional<tTJSString> ser_key = boost::none
			);
		void load(
			tTJSVariant const* ar_v,
			tTJSString const& key,
...
#endif	// #ifndef SRC_SERIALIZATION_SERIALIZATION_DECL_HPP
